...
LDFLAGS+=-L. -g
#^|
EXAMPLESOBJS=  fsm.o register.o queue.o main.o generat.o cpu.o transduc.o distri.o com.o linpack.o debug.o trafico.o
#!
...
#^|
fsm.o: /cygdrive/C/eclipse/workspace/fsm/fsm.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
register.o: /cygdrive/C/eclipse/workspace/fsm/register.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
#
...
#^|
fsm.o: /cygdrive/C/eclipse/workspace/fsm/fsm.cpp \
 /cygdrive/C/eclipse/workspace/fsm/fsm.h \
